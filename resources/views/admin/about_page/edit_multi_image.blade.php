            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('update.multimage')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="multi_image_id" value="{{$multiImage->id}}">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg"
                                        src="{{asset('storage/multi-image/'.$multiImage->multi_image)}}" alt="Card image cap">
                                </div>
