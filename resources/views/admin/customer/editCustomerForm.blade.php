                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('update.customer',$customer->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="mobile_no" type="text" id="mobile_no" value="{{$customer->mobile_no}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="address" type="text" id="address" value="{{$customer->address}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="customer_image" type="file"
                                        id="customer_image" value="{{$customer->customer_image}}">
                                </div>
                            </div>
