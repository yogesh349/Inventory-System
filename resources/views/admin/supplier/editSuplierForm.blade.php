                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('update.supplier',$supplier->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="mobile_no" type="text" id="mobile_no" value="{{$supplier->mobile_no}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="address" type="text" id="address" value="{{$supplier->address}}">
                                </div>
                            </div>
